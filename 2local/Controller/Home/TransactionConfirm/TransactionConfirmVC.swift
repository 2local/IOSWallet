...
class TransactionConfirmVC: BaseVC {
    ...
    fileprivate func setupView() {
        ...
        gasSegment.setTitleTextAttributes([.font: UIFont.TLFont(weight: .regular,
                                                                size: 13,
                                                                style: .body),
                                           .foregroundColor: UIColor._303030],
                                          for: .normal)
        ...
        if #available(iOS 13.0, *) {
            gasSegment.selectedSegmentTintColor = ._mediumSlateBlue
        } else {
            gasSegment.tintColor = ._mediumSlateBlue
        }
    ...
    @IBAction func ConfirmTapped(_ sender: UIButton) {
        ...
        currentWallet.send(to,
            ...
            if txHash.hasPrefix("0x") {
                let vc = UIStoryboard.transaction.instantiate(viewController: TransactionReciptVC.self)
