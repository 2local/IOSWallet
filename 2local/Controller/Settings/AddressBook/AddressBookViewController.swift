    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.section == 0 {
            if contacts.count == 0 {
                ...
                let contactCell = tableView.dequeueReusableCell(withIdentifier: "contactCell") as! AddressBookTableViewCell
            ...
            let footerCell = tableView.dequeueReusableCell(withIdentifier: "footerCell") as! AddressBookFooterTableViewCell
