...
class WalletCollectionViewCell: UICollectionViewCell {
    ...
    override func awakeFromNib() {
        ...
        containerView.backgroundColor = .f2f2f8
        ...
        sendButton.backgroundColor = .mediumSlateBlue
        ...
        receiveButton.backgroundColor = .shamrock
